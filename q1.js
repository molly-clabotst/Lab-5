...
//
// let oneHunEur = 100;
// let ausDol = rates.AUD*oneHunEur;
// console.log(ausDol);
//
// let largest =1;
// let largestNam = "";
...
//     }
// }
// console.log(`The currency with the greatest exchange rate in comparison to the Euro
// is ${largestNam} at a rate of ${largest}`);
//
...
// let celebrity = {name: 'Taylor Swift', cat: 'Meredith'};
// cats_and_owners.push(celebrity);
// for(var celeb in cats_and_owners){
//     console.log(cats_and_owners[celeb]);
// }
...
console.log(`\nThese are the IDs of the winners in Physics:`);
for(var index in nobel_prize_winners_2017.prizes[0].laureates){
    console.log(nobel_prize_winners_2017.prizes[0].laureates[index].id);
}

console.log(`\nThese are the prize categories:`)
for (var index in nobel_prize_winners_2017.prizes) {
    console.log(nobel_prize_winners_2017.prizes[index].category);
}

console.log(`\nThere are ${nobel_prize_winners_2017.prizes.length} Nobel Prize categories`);

let num = 0;
for (var index in nobel_prize_winners_2017.prizes) {
    for (var xedni in nobel_prize_winners_2017.prizes[index].laureates) {
        num++;
    }
}
console.log(`\nThe total number of laureates for 2017 was ${num}`);